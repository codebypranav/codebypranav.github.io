      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose lg:prose-xl">
          ...
          <section className="mb-8">
            ...
            <p>My friends know me as the record-keeper and dad of my group, my sister knows me as a trouble-maker, we can get to know each other productively, but I like to think of myself as someone who manages to keep a light heart while also producing results.</p>
          </section>
